...
const OutletProducts = () => {
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-2 xl:grid-cols-2 2xl:grid-cols-4 gap-x-[0.5rem] gap-y-[0.45rem] bg-white place-items-start max-h-screen overflow-y-auto overflow-x-hidden p-1.5">
        {isLoading ? (
